...
import com.example.myviewpagertest.adapter.PagerAdapter;
...
public class ViewPager extends ViewGroup {
    ...
    private static final int MAX_SETTLE_DURATION = 600; // 页面切换滑动最长时间ms
    ...
    //private Drawable mMarginDrawable;//页面之间空白间隔绘制
    ...
    private boolean mScrolling;//页面滑动状态
     ...
     */
    private float mLastMotionX;//滑动过程上一触碰点x坐标
    private float mLastMotionY;//滑动过程上一触碰点y坐标
    /**
    ...
    private EdgeEffectCompat mLeftEdge;//滑动到左边缘颜色渐变和反弹动作
    private EdgeEffectCompat mRightEdge;//滑动到右边缘颜色渐变和反弹动作

    private boolean mFirstLayout = true;//onAttachedToWindow调用是设为true，即第一次onDraw前调用
    ...
    private int mScrollState = SCROLL_STATE_IDLE;//滑动状态，默认为静止
